...
from .models import Propiedad, Usuario, Oferta, Conversacion, Mensaje, Favorito, Notificacion
...
def lista_propiedades(request):
    ...
    if usuario_actual.tipo_usuario == 'Administrador':
        ...
        propiedades = Propiedad.objects.filter(usuario__tipo_usuario='Administrador', disponibilidad='Disponible')
